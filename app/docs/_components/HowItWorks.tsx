      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <InfoCard title="Technikalia" iconColor="bg-white">
          <p className="text-neutral-400 text-sm leading-relaxed font-mono">
            Model przeszedł pre-training na pełnym korpusie tekstów Taco z
            Geniusa. Został dostosowany do obsługi{" "}
            <span className="text-white">znaczników markup</span>, które są
            traktowane jako{" "}
            <span className="text-white">pojedyncze, niepodzielne tokeny</span>.
            Dzięki temu model świetnie rozumie strukturę utworu bez marnowania
            limitu na techniczne znaki.
          </p>
        </InfoCard>

        <InfoCard title="Jak Karmić Model" iconColor="bg-blue-500">
          <p className="text-neutral-400 text-sm mb-4 font-mono">
            Możesz pisać &quot;na żywioł&quot; lub wymusić konkretną sekcję za
            pomocą tagów:
          </p>
          <div className="space-y-2 font-mono text-xs">
            <CodeBadge>
              <span className="text-neutral-500">
                {"// Styl dowolny (dokańczanie)"}
              </span>
              <br />
        ...
        >
          <div>
            <p className="text-neutral-400 text-sm font-mono max-w-xl">
              Określa limit wygenerowanego tekstu. Dla uproszczenia:
              <span className="text-white ml-2">
                1 Token ≈ 1 Litera LUB 1 Tag
              </span>
              .
            </p>
          </div>
